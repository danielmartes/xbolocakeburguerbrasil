...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // TENTATIVA 27: Usando o formato v1/action/send_email (com v1 no meio)
    const response = await fetch("https://api.lovable.dev/v1/connectors/google_mail/v1/action/send_email", {
      method: "POST",
      headers: {
