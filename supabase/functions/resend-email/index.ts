...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Formato que simula o envio de e-mail via gateway unificado para conectores que suportam e-mail
    const response = await fetch("https://api.lovable.dev/v1/connectors/google_mail/email/send", {
      method: "POST",
      headers: {
