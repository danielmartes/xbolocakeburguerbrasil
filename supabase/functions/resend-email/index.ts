...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // TENTATIVA 20: Usando o formato de "action" como o próprio endpoint
    const response = await fetch("https://api.lovable.dev/v1/connectors/google_mail/action/gmail.users.messages.send", {
      method: "POST",
      headers: {
